...
std::string CheckGeneralizedTime(std::string value)
{
    ...
    */
    ...
    QRegularExpression timeFormat("^[0-9]{14}\\.([0-9]{1,6}|[0-9]{1,6}Z|[0-9]{1,6}\\-[0-9]{4}|[0-9]{1,6}\\+[0-9]{4})$");
    QRegularExpressionMatch match =   timeFormat.match(value.c_str());
...
std::string CheckUTCTime(std::string value)
{
    ...
    */
    ...
    QRegularExpression timeFormat("^[0-9]{12}\\.([0-9]{1,6}|[0-9]{1,6}Z|[0-9]{1,6}\\-[0-9]{4}|[0-9]{1,6}\\+[0-9]{4})$");
    QRegularExpressionMatch match = timeFormat.match(value.c_str());
    QStringList listName = match.capturedTexts();
    return listName.length() > 1 ? "" : "There is not a generalized time";
}
